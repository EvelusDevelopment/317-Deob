...
public class BZ2Decompressor {
    ...
    public static void method226(BZ2Entry class32)
    {
...
label0:
    ...
    public static void method227(BZ2Entry class32)
    {
        boolean flag = false;
        boolean flag1 = false;
        boolean flag2 = false;
        ...
        if(BZ2Entry.anIntArray587 == null)
            BZ2Entry.anIntArray587 = new int[class32.anInt578 * 0x186a0];
        boolean flag19 = true;
        while(flag19) 
        {
            ...
            for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
                ...
                } else
                {
                    ...
                    BZ2Entry.anIntArray587[i6] = class32.aByteArray591[byte6 & 0xff] & 0xff;
                    i6++;
                    if(j5 == 0)
                    {
                        i5++;
            ...
            for(int l2 = 0; l2 < i6; l2++)
            {
                ...
                BZ2Entry.anIntArray587[class32.anIntArray585[byte7 & 0xff]] |= l2 << 8;
                class32.anIntArray585[byte7 & 0xff]++;
            }

            class32.anInt581 = BZ2Entry.anIntArray587[class32.anInt580] >> 8;
            class32.anInt584 = 0;
            class32.anInt581 = BZ2Entry.anIntArray587[class32.anInt581];
    ...
    public static byte method228(BZ2Entry class32)
    {
        return (byte)method230(8, class32);
    }

    public static byte method229(BZ2Entry class32)
    {
        return (byte)method230(1, class32);
    }

    public static int method230(int i, BZ2Entry class32)
    {
        int j;
        do
        {
    ...
    public static void method231(BZ2Entry class32)
    {
        class32.anInt588 = 0;
        for(int i = 0; i < 256; i++)
    ...
    public static BZ2Entry aClass32_305 = new BZ2Entry();
