...
public class PalleteNodeTexture
{

    public PalleteNodeTexture(int i, int j, int k, int l, int i1, int j1, int k1, 
    ...
    public static final int anIntArrayArray696[][] = {
        {
            1, 3, 5, 7
        }, {
            1, 3, 5, 7
    ...
    public static final int anIntArrayArray697[][] = {
        {
            0, 1, 2, 3, 0, 0, 1, 3
        }, {
            1, 1, 2, 3, 1, 0, 1, 3
