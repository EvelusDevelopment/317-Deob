...
public class MapLoader {
  ...
  public MapLoader (byte[][][] is, int i, int sizey, int sizex, int[][][] is_2_)
  {
    anInt145 = 99;
    ml_sizex = sizex;
    ml_sizey = sizey;
			...
			if (objtype == 22) {
				if (! lowmemory || class46.aBoolean778 || class46.aBoolean736) {
					...
					if (class46.anInt781 == -1 && class46.anIntArray759 == null)
						...
						class30_sub2_sub4 = new RSObject(objid, objrotation, 22, height_10, (byte) 7, height_11, height_00, height_01, class46.anInt781, true);
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
				  ...
				  class30_sub2_sub4 = new RSObject (objid, objrotation, 10, height_10, (byte) 7, height_11, height_00, height_01, class46.anInt781, true);
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
					...
					class30_sub2_sub4 = new RSObject (objid, objrotation, objtype, height_10, (byte) 7, height_11, height_00, height_01, class46.anInt781, true);
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
					...
					class30_sub2_sub4 = new RSObject (objid, objrotation, 0, height_10, (byte) 7, height_11, height_00, height_01, class46.anInt781, true);
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
				  ...
				  class30_sub2_sub4 = new RSObject (objid, objrotation, 1, height_10, (byte) 7, height_11, height_00,
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
				  ...
				  {
					class30_sub2_sub4
					  = new RSObject (objid, 4 + objrotation, 2,
									height_10, (byte) 7, height_11,
									height_00, height_01,
									class46.anInt781, true);
					class30_sub2_sub4_138_
					  = new RSObject (objid, i_137_, 2, height_10,
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
				  ...
				  class30_sub2_sub4
					= new RSObject (objid, objrotation, 3, height_10,
								  (byte) 7, height_11, height_00,
								  height_01, class46.anInt781,
								  true);
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null)
				  ...
				  class30_sub2_sub4
					= new RSObject (objid, objrotation, objtype,
								  height_10, (byte) 7, height_11,
								  height_00, height_01,
								  class46.anInt781, true);
				  ...
				  collisionmap.method212 (class46.aBoolean757, anInt138,
					...
					if (objtype == 4) {
						...
						if (class46.anInt781 == -1 && class46.anIntArray759 == null)
							...
							class30_sub2_sub4 = new RSObject (objid, 0, 4, height_10, (byte) 7, height_11, height_00, height_01, class46.anInt781, true);
				...
				byte i_232_)
  {
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  class30_sub2_sub4
	    = new RSObject (i_230_, i, 22, i_234_, (byte) 7,
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  class30_sub2_sub4
	    = new RSObject (i_230_, i, 10, i_234_, (byte) 7,
					  i_235_, i_233_, i_236_,
					  class46.anInt781, true);
	if (class30_sub2_sub4 != null)
	  {
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  class30_sub2_sub4
	    = new RSObject (i_230_, i, i_227_, i_234_, (byte) 7,
					  i_235_, i_233_, i_236_,
					  class46.anInt781, true);
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  class30_sub2_sub4
	    = new RSObject (i_230_, i, 0, i_234_, (byte) 7,
					  i_235_, i_233_, i_236_,
					  class46.anInt781, true);
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  class30_sub2_sub4
	    = new RSObject (i_230_, i, 1, i_234_, (byte) 7,
					  i_235_, i_233_, i_236_,
					  class46.anInt781, true);
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  {
	    class30_sub2_sub4
	      = new RSObject (i_230_, 4 + i, 2, i_234_, (byte) 7,
					    i_235_, i_233_, i_236_,
					    class46.anInt781, true);
	    class30_sub2_sub4_244_
	      = new RSObject (i_230_, i_243_, 2, i_234_,
	...
	if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	  ...
	  class30_sub2_sub4
	    = new RSObject (i_230_, i, 3, i_234_, (byte) 7,
					  i_235_, i_233_, i_236_,
					  class46.anInt781, true);
	class25.putWall (anIntArray140[i], class30_sub2_sub4, true, i_238_,
			   i_226_, i_239_, i_229_, null, i_237_, 0, i_231_);
	...
	if (i_227_ == 4)
	  {
	    ...
	    if (class46.anInt781 == -1 && class46.anIntArray759 == null)
	      ...
	      class30_sub2_sub4 = new RSObject (i_230_, 0, 4, i_234_, (byte) 7, i_235_, i_233_, i_236_, class46.anInt781, true);
		...
		= class46.method578 (4, 0, i_233_, i_234_, i_235_, i_236_, -1);
	      ...
	      class30_sub2_sub4
		= new RSObject (i_230_, 0, 4, i_234_, (byte) 7,
					      i_235_, i_233_, i_236_,
					      class46.anInt781, true);
